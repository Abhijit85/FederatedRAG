...
# Mirror this package under the top-level `textgrad` name so third-party
# modules that expect `import textgrad` keep working without an external pip install.
sys.modules.setdefault("textgrad", sys.modules[__name__])
