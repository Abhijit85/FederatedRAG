...
| runtime_centralized_direct_sourcecap2_pooled | 0.712 | 0.040 | 1=0.650, 2=0.740, 3=0.750, 4=0.700, 5=0.720 |

| Paired quantity | Value |
| --- | ---: |
| Mean diff (runtime_federated - runtime_centralized_direct_sourcecap2_pooled) | +0.216 |
| SD diff | 0.033 |
| SE diff | 0.015 |
| t statistic | +14.697 |
