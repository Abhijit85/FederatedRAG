...
- sample_count: `100`
- seeds: `1,2,3,4,5`
- synapse_arm: `runtime_centralized_clustered`
...
| --- | ---: | ---: | --- |
| runtime_centralized_clustered | 0.328 | 0.018 | 1=0.300, 2=0.340, 3=0.320, 4=0.340, 5=0.340 |
| historical_cv_svm | 0.770 | 0.042 | 1=0.800, 2=0.790, 3=0.720, 4=0.810, 5=0.730 |

| Paired quantity | Value |
| --- | ---: |
| Mean diff (runtime_centralized_clustered - historical_cv_svm) | -0.442 |
| SD diff | 0.047 |
| SE diff | 0.021 |
| t statistic | -21.217 |
