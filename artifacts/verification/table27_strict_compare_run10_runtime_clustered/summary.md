...
- centralized_arm: `runtime_centralized_clustered`
- rounds: `1`
- client_count: `5`
- max_items: `5`
...
| runtime_centralized_clustered | 0.928 | 0.013 | 1=0.920, 2=0.930, 3=0.940, 4=0.910, 5=0.940 |

| Paired quantity | Value |
| --- | ---: |
| Mean diff (runtime_federated - runtime_centralized_clustered) | +0.000 |
| SD diff | 0.000 |
| SE diff | 0.000 |
| t statistic | +0.000 |
